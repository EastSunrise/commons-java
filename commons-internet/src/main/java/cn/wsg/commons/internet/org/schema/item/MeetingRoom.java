 ...
 * conferences and meetings (Source: Wikipedia, the
 * free encyclopedia, see
 * <a href=\"http://en.wikipedia.org/wiki/Conference_hall\">http://en.wikipedia.org/wiki/Conference_hall</a>).
 * <br /><br />
...
public interface MeetingRoom extends Room {
}