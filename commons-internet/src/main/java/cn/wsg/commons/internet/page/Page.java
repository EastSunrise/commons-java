...
public interface Page<T> {
     ...
     * @return the page result
     */
    static <V> CountablePage<V> countable(List<V> content, PageIndex index, int pageSize, int totalPages) {
     ...
     * @return the page result
     */
    static <V> AmountCountablePage<V> amountCountable(List<V> content, PageReq req, long total) {
     ...
     * @return the page result
     */
    static <V> AmountCountablePage<V> amountCountable(List<V> content, PageIndex index, int pageSize, long total) {
