 ...
 * classification, glossaries or dictionaries,
 * product or creative work types, etc. Use the name property for the term being defined, use termCode if the term has
 * an alpha-numeric code allocated, use
