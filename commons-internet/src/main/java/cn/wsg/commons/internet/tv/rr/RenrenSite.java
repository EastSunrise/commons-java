...
public class RenrenSite extends BaseSite implements RenrenTube {
    ...
    public RenrenPage findAll(RenrenReq req) throws NotFoundException {
        ...
        RequestBuilder builder = create("web-api", METHOD_POST, "/web/drama/filter_search");
    ...
    public List<SearchedItem> search(String keyword, int size) {
        ...
        RequestBuilder builder = create("web-api", METHOD_GET, "/web/drama/search/season");
    ...
    @Override
    public RenrenVideo findById(Integer id) throws NotFoundException {
        // todo
        return null;
    }
