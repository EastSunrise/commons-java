...
/**
 * Codes for the representation of names of countries and regions: the codes and English names are based on ISO 3166 and the Chinese names are based on GB/T
 * 2659-2000.
 *
 * @author Kingen
 */
...
public enum Region {
    ...
    // regions with no suitable existing codes in ISO 3166 (AA, QM-QZ, XA-XZ, ZZ and AAA-AAZ, QMA-QZZ, XAA-XZZ, ZZA-ZZZ and 900-999)
