...
public @interface RdfProperty {
     ...
     * other, but in reversed direction. For
     * example, the 'alumni' and 'alumniOf' properties are inverseOf each other. Some properties don't have explicit
     * inverses; in these situations RDFa and
